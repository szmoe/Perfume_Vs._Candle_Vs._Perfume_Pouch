...
to have impact, with a view to impact targets, appropriate strategy, impact pathways help ensure activities are connected to outcomes in a plausible ways, weak links become obvious in impact pathways, research gaps can't be identified without talking to farmers, 

can the interventions be new?

part 2

incorporate uncertainty using stochastic modeling tools
monte carlo simulation 1+3 , or use value of information, certain relatinship, provide 3 examples of uncertain values, 3 variables 

part 3

include all important aspects, use local and expert knowledge, interventions based on experts or literature?, identify key uncertainties via value of information analysis
